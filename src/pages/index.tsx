...
const IndexPage: React.FC<PageProps> = () => {
  const services = [
    {
      title: 'Bridal Makeup',
      description: 'Look stunning on your special day with professional bridal makeup that lasts all day long.',
      price: 'From $200',
      icon: '👰',
    },
    {
      title: 'Special Events',
      description: 'Perfect makeup for proms, parties, galas, and any special occasion you want to shine.',
      price: 'From $100',
      icon: '🎉',
    },
    {
      title: 'Photo Shoots',
      description: 'Camera-ready makeup designed specifically for photography and video production.',
      price: 'From $150',
      icon: '📸',
    },
  ];
        ...
        <div className="container">
          ...
          <div className="about-preview-content">
            <p>
              ...
              wedding day, a special event, or a professional photo shoot, I'm here to make you
...
export const Head: HeadFC = () => (
  <>
    ...
    <meta name="description" content="Professional makeup artist specializing in bridal, events, and photoshoot makeup. Book your consultation today." />
  </>
);
